    ...
    <div className="w-full h-screen flex justify-center items-center">
      <div className="w-[97%] h-[100%]">
        <div className="border-b flex">
          <p className="text-[25px] p-3 font-[700]">History</p>
          <div className="mt-[5px] w-[50px] h-[50px] rounded-[50%] flex justify-center items-center bg-blue-950 cursor-pointer transition-all duration-500 hover:bg-slate-200 text-[white]">
            <FaHistory className="text-[30px]" />
          </div>
        </div>
        <div className="grid grid-cols-2 xl:grid-cols-3 h-[30%] mt-9 gap-4">
                  ...
                  <div className="col-span-3 p-3">
                    <div className="w-full h-[60%] flex">
                      ...
                      <div>
                        ...
                        <div className="ml-4">
                          <span className="font-[600] text-[19px]">Price:</span>{" "}
                          ${props.price}
                        </div>
                        <div className="ml-4">
                          <span className="font-[600] text-[19px]">Unit:</span>{" "}
                          5unit Left
                        </div>
                        <div className="ml-4 w-[100px] h-8">
                            Purchased By
                        </div>
                      </div>
                    </div>
                    <div className="font-[700] flex border xl:w-[17%] w-[30%] rounded-md mt-10 hover:bg-blue-950 transition-all duration-300 cursor-pointer hover:text-[white]">
                      ...
                      <button className="ml-4 text-[crimson] text-[13px] hover:text-[white]">
                        Delete History
                      </button>
                    </div>
                  </div>
